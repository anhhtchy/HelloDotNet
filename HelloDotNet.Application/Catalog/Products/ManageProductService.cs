...
namespace HelloDotNet.Application.Catalog.Products
{
    public class ManageProductService : IManageProductService
    {
            ...
            GetManageProductPagingRequest request)
        {
            ...
            {
                query = query.Where(x =>
                    request.CategoryIds.Contains(x.pic.CategoryId));
            }
            // Paging
            ...
            if (request.ThumbnailImage != null)
            {
                ...
                if (thumbnailImage != null)
                {
                    ...
                    thumbnailImage.ImagePath =
                        await this.SaveFile(request.ThumbnailImage);
        ...
        public async Task<int> AddImage(int productId, ProductImageCreateRequest request)
        {
            ...
            if (request.ImageFile != null)
            {
                productImage.ImagePath =
                    await this.SaveFile(request.ImageFile);
        ...
        public async Task<int> RemoveImage(int imageId)
        {
            ...
            {
                throw new EShopException(
                    $"Cannot find an image with id {imageId}");
            }
        ...
        public async Task<List<ProductImageViewModel>> GetListImages(
            int productId)
        {
